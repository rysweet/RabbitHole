...
| Exported project smoke | `status.txt`, `command.log`, generated source or exported project listing, launcher handoff, compile evidence, or exported Ant runtime metadata evidence such as `ANT_RUNTIME_CONFIGURATION_PROBE_OK`. |
