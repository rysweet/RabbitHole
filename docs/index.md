...
- [First-Lesson Live Procedure Target Action Seam](./reference/first-lesson-live-procedure-target-observation.md) - read-only live desktop shard contract for opening the first-lesson starter through Select Project and proving edit-ready evidence or the named CodeEditor/CodeComposite edit-action blocker.
