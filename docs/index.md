...
- [Desktop Run execution and render-affordance evidence](./reference/alice-desktop-outside-in-qa.md#desktop-run-execution-and-render-affordance-evidence) - opt-in VM execution and non-coordinate render-target attachment evidence for Run.
