...
- [PR 402 Reopen/Edit Recovery Output Contract](./reference/pr-402-reopen-edit-recovery-output-contract.md) - Exact-head default-workflow recovery output contract for choosing between scoped `Files modified` evidence and a machine-checkable `No-op justification`.
