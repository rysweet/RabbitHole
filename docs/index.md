...
- [Project Archive Reopen/Edit Seam](./reference/project-archive-reopen-edit-seam.md) - Reference for the bounded file-backed `.a3p` reopen, required edit/write assertion, second reopen, export, invalid archive, loader classification, and guard root-detection contract.
