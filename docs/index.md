...
- [Save Menu Dialog Write Proof](./reference/save-menu-dialog-write-proof.md) - Planned reference for the bounded Save menu item, Swing `JFileChooser`, and `.a3p` write proof shard.
...
- [Run the Save Menu Dialog Write Proof](./howto/run-save-menu-dialog-write-proof.md) - How to run the planned focused desktop-safe Save menu/dialog/write proof with Xvfb when needed.
