...
- [Default workflow recovery report](./reference/default-workflow-recovery-report.md) - repo-path resolution, no-op guard, required `Files modified` section, focused validation, bounded claims, and clean-head readiness evidence for PR branch recovery.
