...
- [Desktop Run execution gap report](./reference/desktop-run-execution-gap-report.md) - planned fail-closed report for bounded Run-window evidence and the missing deterministic world-advance proof blocker.
