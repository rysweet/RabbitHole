...
- [Alice modernization scorecard](./reference/modernization-scorecard.md) - reproducible scorecard snapshot for ratchets, measured coverage availability, production hotspots, QA journey gaps, corpus gaps, and remaining blockers.
