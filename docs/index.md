...
- [Alice Desktop Silver-Thread Status Report](./reference/silver-thread-status-report.md) - [PLANNED] implementation-pending contract for a fail-closed shell QA report that will aggregate bounded launch, starter change, object placement, procedure edit, run-window/render-affordance, and optional Save/reopen evidence.
