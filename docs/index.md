...
- [PLANNED: First-Lesson Live Procedure Target Action Seam](./reference/first-lesson-live-procedure-target-observation.md) - intended read-only live desktop shard contract for opening the first-lesson starter through Select Project and producing edit-ready-or-named-blocker evidence.
