...
- [Finalize exported NetBeans Ant smoke recovery](./howto/finalize-exported-netbeans-ant-smoke-recovery.md) - How to collect readiness, scenario contract, gated command, workflow, and focused Ant smoke evidence for a bounded recovery handoff.
