...
- [Project Archive Reopen/Edit Seam](./reference/project-archive-reopen-edit-seam.md) - Reference for the bounded file-backed `.a3p` reopen, edit/write, second reopen, export, invalid archive, loader classification, and no-op guard root contract.
...
- [Validate the Project Archive Reopen/Edit Seam](./howto/validate-project-archive-reopen-edit-seam.md) - How to run focused `core/ide` validation for the repository-owned archive reopen/edit seam.
...
- [Tutorial: Trace the Project Archive Reopen/Edit Seam](./tutorials/trace-project-archive-reopen-edit-seam.md) - Guided review of the file-backed archive journey, edit persistence assertion, export readback, loader rejection, and non-claims.
