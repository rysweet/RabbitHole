...
- [PR #401 UI Action Menu Contract Handoff](./reference/pr401-ui-action-menu-contract-evidence.md) - exact-head feature-contract handoff for the bounded `alice-desktop-menu-action-smoke` recovery evidence and no-op source justification.
