...
- [Decode coverage characterization](./reference/decode-coverage-characterization.md) - build contract, API behavior, examples, and tutorial guidance for Tweedle, planned literal arithmetic field initializers, player/type archive, and resource decode tests.
