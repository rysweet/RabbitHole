...
- [Generated Story API Runtime State Characterization](./reference/generated-story-api-runtime-state-characterization.md) - Reference for the headless generated-runtime evidence lane for `setSimulationSpeedFactor(1.5)`, direct `configureStory()` invocation, and deterministic non-visual state.
