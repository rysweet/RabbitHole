...
- [Generated Story API Listener Runtime Dispatch Characterization](./reference/generated-story-api-listener-source-characterization.md) - Reference for the bounded headless evidence lane for generated listener registration, compilation, scene activation dispatch, and no-desktop boundaries.
