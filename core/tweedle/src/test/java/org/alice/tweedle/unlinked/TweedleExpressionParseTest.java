...
public class TweedleExpressionParseTest {
  ...
  public void createdConcatenationExpressionShouldContainCorrectResult() {
    StringConcatenationExpression tested = (StringConcatenationExpression) parseExpression("\"hello\" .. \" there\"");
    assertEquals("The StringConcatenationExpression should evaluate correctly.", "hello there", ((TweedlePrimitiveValue) tested.evaluate(null)).getPrimitiveValue());
  }
  ...
  public void concatenationExpressionShouldForceType() {
    ...
    assertEquals("The StringConcatenationExpression should evaluate correctly.", "34", ((TweedlePrimitiveValue) tested.evaluate(null)).getPrimitiveValue());
  }
  ...
  public void createdAdditionExpressionShouldContainCorrectResult() {
    AdditionExpression tested = (AdditionExpression) parseExpression("3 + 4");
    assertEquals("The AdditionExpression should evaluate correctly.", 7, ((TweedlePrimitiveValue) tested.evaluate(null)).getPrimitiveValue());
  }
  ...
  public void compoundMathShouldEvaluate() {
    ...
    assertEquals("The compound expression should evaluate correctly to an int.", 2, ((TweedlePrimitiveValue) tested.evaluate(null)).getPrimitiveValue());
  ...
  public void compoundMathShouldSpreadType() {
    ...
    assertEquals("The compound expression should evaluate correctly to a double.", 2.0, ((TweedlePrimitiveValue) tested.evaluate(null)).getPrimitiveValue());
  }
